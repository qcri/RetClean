    ...
    try:
        ...
        for x in range(len(target_tuple_strings)):
            reranked_results = ranker.rank(
                ...
                docs=retrieved_tuples_strings[x],
            ...
            new_reranked_list.append(
                [
                    {
                        "values": reranked_results[i].document.text,
                        "table_name": reranked_results[i].metadata["table_name"],
                        "row_number": reranked_results[i].metadata["row_number"],
                    }
